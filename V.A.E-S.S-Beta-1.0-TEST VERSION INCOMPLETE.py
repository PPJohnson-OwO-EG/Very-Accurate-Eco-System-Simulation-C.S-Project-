...
#help menu
helpmenu = input('\033[0mWould you like some help?-\033[0m \033[92mYES(RECCOMMENDED)\033[92m \033[91mNO\033[91m\033[0m-\033[0m')
helpmenu2 = 0
...
if helpmenu == 'YES':
    ...
    while helpmenu2 == 1:
        ...
        print("Predators, Prey, Plants, Scavengers, Climate Change, Events, Weather, Seasons, Ticks, Patch Notes. Type 'Exit' to leave.")
        helprequest = input('Enter-')
        if helprequest == 'Exit':
            print()
            break
        if helprequest == 'Predators':
            print()
        ...
        if helprequest == 'Ticks':
            ...
            time.sleep(1.5)
            print('----------------------------------------------')
        if helprequest == 'Patch Notes':
            print()
            print('Choose: Alpha-1, Alpha-1.5, Alpha-2.0, Alpha-3.0 or Beta-1.0')
            patchnote = input('Which patchnotes would you like to read?-')
            if patchnote == 'Alpha-1':
                print()
...
while True:     #somehow works idk, dont touch too much
    ...
    if season>=1 and season<=3:
        ...
        print(f'{CYAN}Autumn{RESET}!')
    elif season>=7 and season <=9:
        print(f'{WHITE}Winter{RESET}!')
