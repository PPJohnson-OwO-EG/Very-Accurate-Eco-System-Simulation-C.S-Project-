...
time.sleep(0.75)
print('A.K.A Very Accurate Eco-System Simulator (BETA-2.1)')
print()
#patch notes
time.sleep(2)
print()
...
#disease debuffs
    ...
    if human2 == 1 and random.randint(0,10) == 5:                                #unfinished human stuff
        print()
        print('----------------------------------------------')
